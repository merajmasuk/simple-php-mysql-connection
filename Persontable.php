            ...
            <div class="screen__content">
                <form form action="<?php htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="post" class="login">
                    <div class="login__field">
                        <input type="number_format" name="id" class ="login__input" required="required" placeholder="Enter Person ID" />
                    </div>
                    <div class="login__field">
                        <input type="text" name="name" class ="login__input" required="required" placeholder="Enter Person Name" />
                    </div>
                    <div class="login__field">
                        <input type="text" name="sex" class ="login__input" required="required" placeholder="Enter Person Sex M or F" />
                    </div>
                    <div class="Dlogin__field">
                        <input type="date" name="dob" class ="login__input" required="required" placeholder="Enter Person Date of Birth" />
                    </div>
